...
from fairseq.modules.biram_sentence_encoder_layer import BiRAMSentenceEncoderLayer
from fairseq.modules.biram_sentence_encoder_layer import BiRAM_Layer
...
class BiRAMLRAEncoder(nn.Module):
    """
    Implementation for a BiRAM based Sentence Encoder used
    in BERT/XLM style pre-trained models.

    This first computes the token embedding using the token embedding matrix,
    position embeddings (if specified) and segment embeddings
    (if specified). After applying the specified number of
    BiRAMSentenceEncoderLayer, it outputs all the internal states of the
    ...
    def __init__(
        ...
        self.biraml = BiRAM_Layer(embedding_dim=self.embedding_dim, b_count=self.block_count, b_size=self.block_size, dropout=dropout)
