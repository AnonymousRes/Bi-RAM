...
class Options(object):
    ...
    def __init__(self):
        ...
        # Model
        self.parser.add_argument('--model', type=str, default="biram",
                                 help="Model class")
        ...
        self.parser.add_argument('--pos_encoding', choices={'fixed', 'learnable'}, default='fixed',
                                 help='Internal dimension of transformer embeddings')
        self.parser.add_argument('--activation', choices={'relu', 'gelu', 'silu'}, default='relu',
        ...
        self.parser.add_argument('--ktimes', type=int, default=1)
